 ...
 * esp32 Gmail send example with 2 attach loaded in FFat
 *
 *	Remember to change the STORAGE TYPE like so
...
void setup()
{
    ...
    message.message += "This email includes a file attachment from FFat filesystem.<br><br>";
