...
EMailSender emailSend("smtp.account@gmail.com", "password", "emailfrom@gmail.com", "Name of email from");
...
void setup()
{
    ...
    message.message += "This example demonstrates custom sender name configuration.<br><br>";
